...
class Product(TimeStampedModel):
    ...
    image = models.ImageField(upload_to="images/products/", null=True, blank=True, default="https://www.tiffincurry.ca/wp-content/uploads/2021/02/default-product.png", max_length=400)
